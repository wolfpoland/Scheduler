    ...
    namespace Scheduler.Data
    {
        public class SchedulerDbInitializer
        {
            ...
            private static void InitializeSchedules()
            {
                ...
                {
                    Model.Entities.User user_01 = new Model.Entities.User { Name = "Chris Sakellarios", Profession = "Developer", Avatar = "avatar_02.png" };

                    Model.Entities.User user_02 = new Model.Entities.User { Name = "Charlene Campbell", Profession = "Web Designer", Avatar = "avatar_03.jpg" };

                    Model.Entities.User user_03 = new Model.Entities.User { Name = "Mattie Lyons", Profession = "Engineer", Avatar = "avatar_05.png" };

                    Model.Entities.User user_04 = new Model.Entities.User { Name = "Kelly Alvarez", Profession = "Network Engineer", Avatar = "avatar_01.png" };

                    Model.Entities.User user_05 = new Model.Entities.User { Name = "Charlie Cox", Profession = "Developer", Avatar = "avatar_03.jpg" };

                    Model.Entities.User user_06 = new Model.Entities.User { Name = "Megan	Fox", Profession = "Hacker", Avatar = "avatar_05.png" };
                ...
                {
                    Model.Entities.Schedule schedule_01 = new Model.Entities.Schedule
                    {
                        Title = "Meeting",
                        Description = "Meeting at work with the boss",
                        Location = "Korai",
                        CreatorId = 1,
                        Status = Model.Entities.ScheduleStatus.Valid,
                        Type = Model.Entities.ScheduleType.Work,
                        TimeStart = DateTime.Now.AddHours(4),
                        TimeEnd = DateTime.Now.AddHours(6),
                        Attendees = new List<Model.Entities.Attendee>
                    {
                        new Attendee() { ScheduleId = 1, UserId = 2 },
                        new Model.Entities.Attendee() { ScheduleId = 1, UserId = 3 },
