...
namespace Scheduler.API.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public IActionResult Get()
        {
            ...
            IEnumerable<User> _users = _userRepository.AllIncluding(u => u.SchedulesCreated)
                .OrderBy(u => u.Id).Skip((currentPage - 1) * currentPageSize)
        ...
        public IActionResult Delete(int id)
        {
            ...
            }else
            {
                ...
                {
                    _attendeeRepository.Delete(item);
                }
                foreach (var item in _schedules)
                {
                    _attendeeRepository.DeleteWhere(a => a.ScheduleId == item.Id);
