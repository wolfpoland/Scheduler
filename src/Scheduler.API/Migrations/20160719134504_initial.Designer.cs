...
namespace Scheduler.API.Migrations
{
    ...
    [Migration("20160719134504_initial")]
            ...
            modelBuilder.Entity("Scheduler.Model.Entities.Schedule", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2016, 7, 19, 15, 45, 4, 298, DateTimeKind.Local));

                    b.Property<DateTime>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2016, 7, 19, 15, 45, 4, 307, DateTimeKind.Local));
